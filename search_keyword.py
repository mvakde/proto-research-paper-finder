        ...
        functions=[
            {
                ...
                "description": "Processes and filters diagnoses keywords",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "diagnoses": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "A list of diagnosis keywords to process.",
                        }
                    },
                    "required": ["diagnoses"],
                },
...
def main():
    ...
    user_prompt_3 = "Out of all these keywords, List down 15 keywords that you think are most relevant . Ensure that these keywords are as mutually exclusive as possible and cover a wide enough area of possible diagnoses. ENSURE that your next response is the list of 15 keywords and ONLY the list. DO NOT inlude any extra information or greetings etc."
